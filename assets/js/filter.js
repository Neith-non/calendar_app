...
function openModal(cardElement) {
  ...
  const category =
    cardElement.getAttribute("data-category") || "Not categorized";
...
function confirmAction(url, action) {
  ...
  const detailText = isApprove
    ? "It will be officially added to the calendar."
    : "It will be removed from the system permanently.";
